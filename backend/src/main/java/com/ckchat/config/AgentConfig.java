package com.ckchat.config;

import com.ckchat.advisor.PersonalizationAdvisor;
import com.ckchat.advisor.ProfileWarningAdvisor;
import com.ckchat.advisor.SummarizationAdvisor;
import com.ckchat.agent.AgentDefinition;
import com.ckchat.agent.AgentDefinitionLoader;
import com.ckchat.service.ProfileScoreService;
import com.ckchat.tools.*;
...
public class AgentConfig {
    ...
    @Value("${ckchat.agents.config-path:classpath:agents/*.md}")
    private String agentConfigPath;

    @Value("${ckchat.conversation.max-messages-before-summarization:10}")
    private int maxMessages;

    @Value("${ckchat.conversation.messages-to-keep-after-summarization:5}")
    private int keepAfterSummarization;

    @Value("${ckchat.conversation.profile-low-completion-threshold:50}")
